...
AVS_TEAM = {
    "endpoint": "https://statsapi.web.nhl.com/api/v1/teams/21",
    "endpoint_name": "team",
}

AVS_TEAM_STATS = {
    "endpoint": "https://statsapi.web.nhl.com/api/v1/teams/21/stats",
    "endpoint_name": "team stats",
}

AVS_ROSTER = {
    "endpoint": "https://statsapi.web.nhl.com/api/v1/teams/21/roster",
    "endpoint_name": "roster",
}

AVS_PLAYER_REG_SEASON = {
    "endpoint": "https://statsapi.web.nhl.com/api/v1/people/{player_id}/stats?stats=statsSingleSeason&season=20202021",
    "endpoint_name": "player_stats_single_season_reg",
}

ENDPOINT_NAMES = ["team", "team stats", "roster", "player_stats_single_season_reg"]
